...
public class HelloWorldApplicationTests {
    ...
    public void shouldReturn200WhenSendingRequestToController() throws Exception {
        System.out.println("this.port: " + this.mgt);
        System.out.println("this.mgt: " + this.mgt);
        ...
        System.out.println("entity get status code value: " + entity.getStatusCodeValue());
        Assert.assertEquals(200, entity.getStatusCodeValue());
        System.out.println("to string: " + entity.toString());
    }
